...
router.post('/', (req, res) => {
  console.log("hello",req.body.exercises)
...
router.put('/:id', (req, res) => {
  ...
  const updated = {};
  const updateableFields = ['workouts'];
...
router.put('/:id/:exerciseid', (req, res) => {
  console.log(req.body, req.params.id, req.params.exerciseid);
  if(!(req.params.exerciseid && req.body.id && req.params.exerciseid === req.body.id)) {
